...
系統簡介:庵魅點心坊
================================
庵魅點心網是一個介紹製作點心的網站，專門收集點心製作方法給社會大眾，隨著時代演變，手機資訊網路越來越發達，使得書本漸漸得不流行，也為了紙張的減少，所以我們這組建置此網站。
...
|事件名稱|使用案例名稱|
|------------------------------------------------------|------------------------|
|1、對所有會員的基本資料進行建立、查詢、更改及刪除。| 1、會員基本資料作業。 |
|2、對所有產品的資料進行建立、查詢、更改及刪除。|2、產品資料建立作業。|
|3、讓會員快速查詢到想要的資訊。|3、產品資料查詢作業。|
|4、讓會員可以建立分享自己製作點新的方法。|4、產品製作分享作業。|
|5、使用者對我們有哪些意見。| 5、意見回覆作業。|
...
<table>
  ...
  <tr>
 <td>網路管理員</td>
    <td>能夠新增會員所分享的產品製作方法</td>
    <td>是</td>
    </tr>
    <tr>
      <td>分享產品製作方法</td>
    <td>系統需要紀錄會員所分享的資料</td>
    <td>是</td>
    </tr>
    <tr>
    <td>產品需要的材料</td>
